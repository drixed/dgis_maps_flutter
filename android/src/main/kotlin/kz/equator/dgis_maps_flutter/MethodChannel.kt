...
interface PluginHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, id: Int, api: PluginHostApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.getCameraPosition", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.moveCamera", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.moveCameraToBounds", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            var wrapped = listOf<Any?>()
            try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.updateMarkers", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            var wrapped = listOf<Any?>()
            try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.createRoute", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            var wrapped = listOf<Any?>()
            try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.updatePolylines", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            var wrapped = listOf<Any?>()
            try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.changeMyLocationLayerState", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            var wrapped = listOf<Any?>()
            try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginHostApi_$id.getVisibleArea", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            var wrapped = listOf<Any?>()
            try {
...
class PluginFlutterApi(private val binaryMessenger: BinaryMessenger, private val id: Int) {
  ...
  fun onCameraStateChanged(cameraStateArg: DataCameraStateValue, callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginFlutterApi_$id.onCameraStateChanged", codec)
  ...
  fun onNativeMapReady(callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "kz.equator.PluginFlutterApi_$id.onNativeMapReady", codec)
    channel.send(null) {
      callback()
    }
  }
